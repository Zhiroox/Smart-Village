...
export default function LayananPage() {
  ...
  const getStatusBadge = (status: ApplicationStatusType) => {
    switch (status) {
      case 'Menunggu':
        return <span className="bg-amber-500/20 border border-amber-400/30 text-amber-300 px-3 py-1 rounded-full text-xs font-bold inline-flex items-center gap-1.5"><Hourglass className="w-3.5 h-3.5" /> Menunggu Verifikasi</span>;
      case 'Diverifikasi':
        return <span className="bg-blue-500/20 border border-blue-400/30 text-blue-300 px-3 py-1 rounded-full text-xs font-bold inline-flex items-center gap-1.5"><CheckCircle2 className="w-3.5 h-3.5" /> Diverifikasi</span>;
      case 'Diproses':
        return <span className="bg-indigo-500/20 border border-indigo-400/30 text-indigo-300 px-3 py-1 rounded-full text-xs font-bold inline-flex items-center gap-1.5"><Clock className="w-3.5 h-3.5" /> Sedang Diproses</span>;
      case 'Selesai':
        return <span className="bg-emerald-500/20 border border-emerald-400/30 text-emerald-300 px-3 py-1 rounded-full text-xs font-bold inline-flex items-center gap-1.5"><FileCheck2 className="w-3.5 h-3.5" /> Surat Selesai</span>;
      case 'Ditolak':
        return <span className="bg-rose-500/20 border border-rose-400/30 text-rose-300 px-3 py-1 rounded-full text-xs font-bold inline-flex items-center gap-1.5"><XCircle className="w-3.5 h-3.5" /> Permohonan Ditolak</span>;
    }
  };
